...
**Deploy**
- Recommended: Deploy backend on Render/Railway/Fly; copy Angular build into `public/` as part of CI/CD.
- Alternatively, host UI separately (Vercel) and point Angular `environment.ts` to backend URL.
